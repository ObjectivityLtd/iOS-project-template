...
When working for early stage startups we frequently had to start new projects from scratch. While doing this we noticed that we are spending a lot of time doing basic project setup and integrating basic tools and best practices in all projects from scratch.
...
```
cookiecutter https://github.com/ObjectivityLtd/iOS-project-template.git
```
