...
/**
UITextField control styled for Design System.

In order to use this control in XIB/Storyboard:
   1. Open Interface Builder.
   2. Add `UITextField` control to your layout.
   3. Open Identity Inspector (View -> Inspectors -> Show Identity Inspector).
   4. In Custom Class section change Class property to `AppTextField`, Module property should change automatically to `DesignSystem`.
